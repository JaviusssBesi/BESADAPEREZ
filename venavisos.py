...
class Ui_dlgAvisos(object):
    def setupUi(self, dlgAvisos):
        ...
        dlgAvisos.resize(437, 167)
        self.btnAceptaviso = QtWidgets.QPushButton(dlgAvisos)
        self.btnAceptaviso.setGeometry(QtCore.QRect(140, 100, 75, 23))
        ...
        self.btnCancelaviso.setGeometry(QtCore.QRect(240, 100, 75, 23))
        ...
        self.lblAvisos.setGeometry(QtCore.QRect(40, 80, 51, 61))
        ...
        self.lblMensaviso.setGeometry(QtCore.QRect(100, 40, 221, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
