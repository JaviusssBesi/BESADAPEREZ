...
"color: rgb(255, 255, 255);")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/backup/backup.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/toolbarcarpeta/carpeta.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
    ...
    def retranslateUi(self, venPrincipal):
        ...
        self.actionToolBarCarpeta.setToolTip(_translate("venPrincipal", "<html><head/><body><p><img src=\":/toolbarcarpeta/carpeta.png\"/></p></body></html>"))
